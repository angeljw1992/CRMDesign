      ...
      <div class="card">
        <div class="row">
          ...
          <div class="col-md-8 ps-md-0">
            <div class="auth-form-wrapper px-4 py-5">
              ...
              <h5 class="text-muted fw-normal mb-4">{{ trans('global.reset_password') }}</h5>
        ...
        @endif
              ...
              @endif
                ...
                <div>
                  <button type ='submit' class="btn btn-primary me-2 mb-2 mb-md-0">  {{ trans('global.send_password') }}</button>
                </div>
